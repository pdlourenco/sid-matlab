...
%   (variable-length trajectories).
    ...
    optDefs.NoiseCov = 'estimate';
    optDefs.CovarianceMode = 'diagonal';
    ...
    noiseCov = optParsed.NoiseCov;
    covMode = optParsed.CovarianceMode;

    if ischar(algorithm) && ~strcmpi(algorithm, 'cosmic')
